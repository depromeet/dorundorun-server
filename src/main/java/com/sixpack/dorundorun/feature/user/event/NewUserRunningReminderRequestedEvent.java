...
@Builder
public record NewUserRunningReminderRequestedEvent(
	Long userId
) implements RedisStreamEvent {

	public static final String TYPE = RedisStreamEventType.NEW_USER_RUNNING_REMINDER_NOTIFICATION_REQUESTED;
